...
export const metadata = {
  title: "Solutions | LΛM Control Panel",
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <Link href="/control-panel/modules/solutions/create" className="btn btn-primary">
          + Create Solution
        </Link>
      </div>
            ...
            {solutions?.map((s) => (
              <tr key={s.slug} style={{ borderBottom: '1px solid var(--lam-border)' }}>
                ...
                <td style={{ padding: '1rem', textAlign: 'right', display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' }}>
                  <Link href={`/control-panel/modules/solutions/${s.slug}/edit`} style={{
                  ...
                  <Link href={`/solutions/${s.slug}`} target="_blank" style={{
                    display: 'inline-block',
                    background: 'none',
