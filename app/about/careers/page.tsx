    ...
    <>
      ...
      <SectionContainer background="black" size="lg">
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "5rem", maxWidth: "1000px", margin: "0 auto" }}>
          ...
          {/* Why work with LAM */}
          <div>
            <h2 style={{ fontSize: "var(--text-3xl)", marginBottom: "1.5rem" }}>{whyData.title || "Why LΛM?"}</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "2rem" }}>
              {(whyData.pillars || [
                ...
                <div key={index} className="lam-card">
                  <h3 style={{ fontSize: "var(--text-xl)", marginBottom: "1rem", color: "var(--lam-gold)" }}>{pillar.title}</h3>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "4rem" }}>
            <div>
              <h2 style={{ fontSize: "var(--text-2xl)", marginBottom: "1.5rem" }}>{internshipsData.internship_title || "Internships & Collaborations"}</h2>
            ...
            <div style={{ background: "var(--lam-charcoal)", padding: "2rem", borderRadius: "var(--radius-lg)", border: "1px solid var(--lam-border)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              <h2 style={{ fontSize: "var(--text-xl)", marginBottom: "1rem" }}>{internshipsData.cta_title || "Submit Your Details"}</h2>
              ...
              <Link href={internshipsData.button_link || "/contact?subject=Careers"} className="btn btn-primary" style={{ justifyContent: "center", width: "100%" }}>
                {internshipsData.button_text || "Submit Application"}
              </Link>
            </div>
          </div>
